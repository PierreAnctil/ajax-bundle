...
var CriteriaTable = function () {
    ...
    self.initialize = function (table_container_id, form_filters_id, reload_route) {
        ...
        //load the pagination length events
        self.paginationLengthEvents();
    ...
    self.changePageLength = function() {
        var pageLengthValue = self.filters_form.find('.page-length').val();
        self.reloadTable();
    };
    ...
    self.reloadTable = function (targetPage, triggerEvents) {
        ...
        self.isReloading = self.ajaxRequest(data, function (response) {
...
//# sourceMappingURL=CriteriaTable.js.map
